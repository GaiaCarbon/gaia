...
class FundraisingDetails extends React.Component {
    ...
    componentDidMount() {
        ...
        if(this.props.fundraisingDetails){
            this.setState({...this.props.fundraisingDetails});
        }
                            ...
                            <div className="col-md-6">
                                <div className="form-group">
                                    <FormControl className="w-100"  margin="normal">
                                        ...
                                        >
                                            {
                                                this.props.selectData.currency.map((value,index)=>{
                            ...
                            <div className="col-md-12">
                                <div className="form-group">
                                    <FormControl className="w-100"  margin="normal">
                                        ...
                                        >
                                            {
                                                this.props.selectData.measurement.map((value,index)=>{
                                                    return <MenuItem key={index} value={value.name}>{value.name}</MenuItem>
                                                })
                                            }
                                        </Select>
